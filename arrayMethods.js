...
var scrambledWordsResult = scrambledWords.reverse();
phoneNumber.reverse();

var orderQueueResult = orderQueue.shift();
var nextOrder = orderQueueResult
...
var updatedOrders = orderQueue.concat([{takeOut: 'Buffalo Wings'}], [{takeOut: 'Coconut Shake'}]);
